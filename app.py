...
def parse_month_year_from_th_question(q: str) -> Optional[Tuple[int, int]]:
    ...
    # Accept both full and abbreviated Thai month names + common colloquial spellings.
    # NOTE: This mapping is intentionally redundant to maximize coverage of real chat inputs.
    thai_month_map = {
        # Jan
        "มกราคม": 1, "มกร": 1, "มกรา": 1, "มกราฯ": 1,
        "ม.ค": 1, "ม.ค.": 1, "มค": 1,
        # Feb
        "กุมภาพันธ์": 2, "กุมภ": 2, "กุมภา": 2,
        "ก.พ": 2, "ก.พ.": 2, "กพ": 2,
        # Mar
        "มีนาคม": 3, "มีนา": 3,
        "มี.ค": 3, "มี.ค.": 3, "มีค": 3,
        # Apr
        "เมษายน": 4, "เมษา": 4, "เมษ": 4,
        "เม.ย": 4, "เม.ย.": 4, "เมย": 4,
        # May
        "พฤษภาคม": 5, "พฤษภา": 5, "พฤษภ": 5,
        "พ.ค": 5, "พ.ค.": 5, "พค": 5,
        # Jun
        "มิถุนายน": 6, "มิถุนา": 6, "มิถุน": 6,
        "มิ.ย": 6, "มิ.ย.": 6, "มิย": 6,
        # Jul
        "กรกฎาคม": 7, "กรกฎา": 7, "กรกฎ": 7,
        "ก.ค": 7, "ก.ค.": 7, "กค": 7,
        # Aug
        "สิงหาคม": 8, "สิงหา": 8, "สิงห": 8,
        "ส.ค": 8, "ส.ค.": 8, "สค": 8,
        # Sep
        "กันยายน": 9, "กันยา": 9, "กันย": 9,
        "ก.ย": 9, "ก.ย.": 9, "กย": 9, "กย.": 9,
        # Oct
        "ตุลาคม": 10, "ตุลา": 10, "ตุล": 10,
        "ต.ค": 10, "ต.ค.": 10, "ตค": 10, "ตค.": 10,
        # Nov
        "พฤศจิกายน": 11, "พฤศจิกา": 11, "พฤศจิก": 11, "พฤศจ": 11,
        "พ.ย": 11, "พ.ย.": 11, "พย": 11, "พย.": 11,
        # Dec
        "ธันวาคม": 12, "ธันวา": 12, "ธันว": 12,
        "ธ.ค": 12, "ธ.ค.": 12, "ธค": 12, "ธค.": 12,
    }
...
def parse_month_name_with_last_year(q: str) -> tuple[int,int] | None:
    ...
    # Thai month names (wide coverage, consistent with parse_month_year_from_th_question)
    th_map = {
        # Jan
        "มกราคม": 1, "มกร": 1, "มกรา": 1, "มกราฯ": 1,
        "ม.ค": 1, "ม.ค.": 1, "มค": 1,
